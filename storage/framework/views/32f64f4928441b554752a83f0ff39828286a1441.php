...
=====================================-->
<!-- jQuery -->
<script src="<?php echo e(url('frontend/company/plugins/jquery/jquery.min.js')); ?>"></script>
<!-- Bootstrap -->
<script src="<?php echo e(url('frontend/company/plugins/bootstrap/bootstrap.min.js')); ?>"></script>
<!-- Slick Slider -->
<script src="<?php echo e(url('frontend/company/plugins/slick-carousel/slick/slick.min.js')); ?>"></script>
<!-- Google Map -->
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCcABaamniA6OL5YvYSpB3pFMNrXwXnLwU"></script>
<script src="<?php echo e(url('frontend/company/plugins/google-map/gmap.js')); ?>"></script>

<script src="<?php echo e(url('frontend/company/js/script.js')); ?>"></script>

</body>

</html>
<?php /**PATH D:\xampp82\htdocs\orondo\main\backup08.07.2023\resources\views/frontend/companyfrontend/layouts/footer.blade.php ENDPATH**/ ?>