...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" href="{{ asset(Storage::url('uploads/logo')) . '' }}" type="image/x-icon" />
        ...
        <div class="container">
            <a class="navbar-brand bg-transparent" href="{{ url("/")}}">
                ...
                {{-- <img src="{{ $logos . '/' . (isset($company_logo) && !empty($company_logo) ? $company_logo : 'light_logo.png') }}"
                    alt="{{ config('app.name', 'SwiftCoSolutions') }}" alt="logo"> --}}
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-sm-12 text-end">
                    ...
                    {{-- <p class="text-body"> {{ __('Copyright') }} &copy;
                        {{ Utility::getValByName('footer_text') ? Utility::getValByName('footer_text') : config('app.name', 'SwiftCoSolutions') }}
                        {{ date('Y') }} </p> --}}
                    <p class="text-body"> {{ __('Copyright') }}
                        {{ Utility::getValByName('footer_text') ? Utility::getValByName('footer_text') : config('app.name', 'Islamiyah Tech') }}
                        {{ date('Y') }} | Design By Islamiyah Tech </p>
                </div>
            </div>
        </div>
