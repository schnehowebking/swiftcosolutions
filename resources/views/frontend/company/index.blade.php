            ...
            <div class="row ">
                <div class="col-lg-4">
                    <div class="service-img">
                        <img src="{{url('frontend/company/images/blog-lg.jpg')}}" alt="" class="img-fluid">
                    </div>
                </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-sm-6 col-md-6">
                    <div class="process-block">
                        <img src="{{url('frontend/company/images/process/process-1.jpg')}}" alt="" class="img-fluid">
                ...
                <div class="col-lg-4 col-sm-6 col-md-6">
                    <div class="process-block">
                        <img src="{{url('frontend/company/images/process/process-2.jpg')}}" alt="" class="img-fluid">
                ...
                <div class="col-lg-4 col-sm-6 col-md-6">
                    <div class="process-block">
                        <img src="{{url('frontend/company/images/process/process-3.jpg')}}" alt="" class="img-fluid">
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-6 col-sm-6 mb-5">
                    <div class="single-project">
                        <img src="{{url('frontend/company/images/projects/p-1.jpg')}}" alt="" class="img-fluid">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 mb-5">
                    <div class="single-project">
                        <img src="{{url('frontend/company/images/projects/p-4.jpg')}}" alt="" class="img-fluid">
                        <div class="project-content">
                ...
                <div class="col-lg-4 col-md-6 col-sm-8 ">
                    <div class="single-project">
                        <img src="{{url('frontend/company/images/projects/p-3.jpg')}}" alt="" class="img-fluid">
                        <div class="project-content">
            ...
            <div class="row py-4">
                <div class="col-lg-7 col-md-12 col-sm-12 ">
                    <div class="single-project">
                        <img src="{{url('frontend/company/images/bg/banner_bg.jpg')}}" alt="" class="img-fluid">
                    </div>
                </div>
                ...
                <div class="col-lg-8 col-sm-12 col-md-12">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="test-inner ">
                                <div class="test-author-thumb d-flex">
                                    <img src="{{url('frontend/company/images/client/test-1.jpg')}}" alt="Testimonial author" class="img-fluid">
                        ...
                        <div class="col-lg-6">
                            <div class="test-inner ">
                                <div class="test-author-thumb d-flex">
                                    <img src="{{url('frontend/company/images/client/test-2.jpg')}}" alt="Testimonial author" class="img-fluid">
                                    <div class="test-author-info">
                                        <h4>Will Barrow</h4>
                                        <h6>Sunrise Paradise Hotel</h6>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="test-inner ">
                                <div class="test-author-thumb d-flex">
                                    <img src="{{url('frontend/company/images/client/test-3.jpg')}}" alt="Testimonial author" class="img-fluid">
                                    <div class="test-author-info">
                                        <h4>Will Barrow</h4>
                                        <h6>Sunrise Paradise Hotel</h6>
                                    </div>
                        ...
                        <div class="col-lg-6">
                            <div class="test-inner ">
                                <div class="test-author-thumb d-flex">
                                    <img src="{{url('frontend/company/images/client/test-4.jpg')}}" alt="Testimonial author" class="img-fluid">
                                    <div class="test-author-info">
                                        <h4>Will Barrow</h4>
                                        <h6>Sunrise Paradise Hotel</h6>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="test-inner">
                                <div class="test-author-thumb d-flex">
                                    <img src="{{url('frontend/company/images/client/test-5.jpg')}}" alt="Testimonial author" class="img-fluid">
                                    <div class="test-author-info">
                                        <h4>Will Barrow</h4>
                                        <h6>Sunrise Paradise Hotel</h6>
                                    </div>
                        ...
                        <div class="col-lg-6">
                            <div class="test-inner">
                                <div class="test-author-thumb d-flex">
                                    <img src="{{url('frontend/company/images/client/test-6.jpg')}}" alt="Testimonial author" class="img-fluid">
                                    <div class="test-author-info">
                                        <h4>Will Barrow</h4>
                                        <h6>Sunrise Paradise Hotel</h6>
                                    </div>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-6">
                    <div class="blog-box">
                        <div class="blog-img-box">
                            <img src="{{url('frontend/company/images/blog/blog-1.jpg')}}" alt="" class="img-fluid blog-img">
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="blog-box">
                        <div class="blog-img-box">
                            <img src="{{url('frontend/company/images/blog/blog-2.jpg')}}" alt="" class="img-fluid blog-img">
                        </div>
                        <div class="single-blog">
                            <div class="blog-content">
                                <h6> 17 October 2018</h6>
                ...
                <div class="col-lg-4 col-md-8">
                    <div class="blog-box">
                        <div class="blog-img-box">
                            <img src="{{url('frontend/company/images/blog/blog-3.jpg')}}" alt="" class="img-fluid blog-img">
                        </div>
                        <div class="single-blog">
                            <div class="blog-content">
                                <h6> 17 October 2018</h6>
