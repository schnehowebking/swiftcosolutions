...
=====================================-->
<!-- jQuery -->
<script src="{{url('frontend/company/plugins/jquery/jquery.min.js')}}"></script>
<!-- Bootstrap -->
<script src="{{url('frontend/company/plugins/bootstrap/bootstrap.min.js')}}"></script>
<!-- Slick Slider -->
<script src="{{url('frontend/company/plugins/slick-carousel/slick/slick.min.js')}}"></script>
<!-- Google Map -->
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCcABaamniA6OL5YvYSpB3pFMNrXwXnLwU"></script>
<script src="{{url('frontend/company/plugins/google-map/gmap.js')}}"></script>

<script src="{{url('frontend/company/js/script.js')}}"></script>
