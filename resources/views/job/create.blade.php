            ...
            <div class="card-body ">
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        {{ Form::select('branch', $branches, null, ['class' => 'form-control select2', 'required' =>
                        'required']) }}
                    </div>
                    <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        {!! Form::text('position', old('positions'), ['class' => 'form-control', 'required' =>
                        'required' ,'placeholder'=>'enter job position']) !!}
                    </div>
                    <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        {!! Form::date('start_date', old('start_date'), ['class' => 'form-control ', 'autocomplete' =>
                        'off' ,'placeholder'=>'Select start date']) !!}
                    </div>
                    <div class="form-group col-md-6">
                            ...
                            <div class="my-4">
                                ...
                                <div class="form-check custom-checkbox">
                                    <input type="checkbox" class="form-check-input" name="visibility[]" value="terms"
                                        id="check-terms">
                                    <label class="form-check-label" for="check-terms">{{ __('Terms And Conditions')
                                        }}</label>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <div class="my-4">
                            ...
                            <div class="form-check custom-checkbox">
                                ...
                                <label class="form-check-label" for="custom_question_{{ $question->id }}">{{
                                    $question->question }}@if ($question->is_required == 'yes')
